...
## How It Works
1. **Preprocessing:** The system reads a directory of PDFs and extracts the text content.
2. **Vectorization:** An embedding model assigns a numerical vector to each paper representing its meaning.
3. **Clustering:** Mathematical algorithms (like K-Means or HDBSCAN) identify neighborhoods of similar papers.
4. **Visualization:** The data is rendered as an interactive scatter plot where proximity indicates semantic relevance.
